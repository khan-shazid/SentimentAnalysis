...
test_data = []
test_labels = []
for fname in os.listdir('E:\Dropbox\ML_Lab\sentiment_labelled_sentences',):
    if fname.endswith('.txt'):
        with open(os.path.join('E:\Dropbox\ML_Lab\sentiment_labelled_sentences',fname), 'r') as input_file:
...
# with open('E:\Dropbox\ML_Lab\TrumpTweets.txt', 'r') as f:
...
# testML_vectors = vectorizer.transform(twitter_data)
# test_predict = mlp.predict(testML_vectors)
# print test_predict
